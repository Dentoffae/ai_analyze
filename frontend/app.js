    ...
    renderParsedContent(data) {
        ...
        return `
            <div class="parsed-content">
                ...
                <div class="label">Контент страницы:</div>
                <div class="value">${parsed.page_content ? parsed.page_content.slice(0, 1500) + (parsed.page_content.length > 1500 ? '...' : '') : 'Не найден'}</div>
            </div>
